...
export default class InventoryList extends Component {
  ...
  render() {
    return ( <div className="inventory">
        ...
        <li className="inventorylabels__item">INVENTORY <img className="labels__icon" src={sort} alt="sort icon"></img></li>
            <li className="inventorylabels__item">ADDRESS <img className="labels__icon" src={sort} alt="sort icon"></img></li>
            <li className="inventorylabels__item">CONTACT NAME <img className="labels__icon" src={sort} alt="sort icon"></img></li>
            <li className="inventorylabels__item">CONTACT INFORMATION <img className="labels__icon" src={sort} alt="sort icon"></img></li>
            ...
            <div className="inventory-list__item">
              <div className="inventory-list__info">
                  ...
                  <div className="inventory-list__grouping">
                    ...
                    <p className="inventory-list__text">{inventory.category}</p>
                  </div>
                </div>
                ...
                <div className="inventory-list__grouping">
                    ...
                    <p className="inventory-list__text">{inventory.warehouse}</p>
                  </div>
                </div>
              </div>

              <div className="inventory-list__actions">
                <img className="inventory-list__icons" src={trash} alt="delete icon" />
                <img className="inventory-list__icons" src={edit_icon} alt="edit icon" />
              </div>
